window.GAME_CONFIG = Object.freeze({
  ...
  baitUpgrades: [
    ...
    { id: "legend", name: "伝説のエサ", cost: 1800, rarityMultiplier: { C: 0.45, R: 0.9, SR: 1.95, SSR: 2.45 }, fishBonus: { "コダマウオ": 1.45, "ネコギョ": 1.45, "ホシクジラ": 1.7 } },
    { id: "abyss", name: "深淵のエサ", cost: 4200, rarityMultiplier: { C: 0.28, R: 0.74, SR: 2.2, SSR: 3.2 }, fishBonus: { "アビスドラゴン": 2, "トキノサカナ": 1.8 } },
  ],
  sizeTiers: [
  ...
  fishingSpots: [
    ...
    },
    {
      id: "estuary",
      name: "夕焼け河口",
      description: "RとSRがほどよく混ざり、夕暮れの魚影が見えやすい。しなやかな竿以上が必要。",
      unlockRodLevel: 1,
      rarityMultiplier: { C: 0.78, R: 1.16, SR: 1.08, SSR: 0.44 },
      bigBonus: 0.18,
      theme: {
        skyTop: "#f08a62",
        skyBottom: "#ffe3a3",
    ...
    },
    {
      id: "abyss",
      name: "幻の海溝",
      description: "SSRと特大を本気で狙う終盤の海。深淵の竿以上が必要。",
      unlockRodLevel: 3,
      rarityMultiplier: { C: 0.28, R: 0.72, SR: 1.82, SSR: 3.15 },
      bigBonus: 0.42,
      theme: {
        skyTop: "#121b35",
        skyBottom: "#2f4b66",
  ...
  missionDefs: [
    ...
    { id: "sr25", label: "SR以上を25匹釣る", target: 25, reward: 3200, kind: "rarityCount", rarity: "SR" },
    { id: "sr100", label: "SR以上を100匹釣る", target: 100, reward: 11000, kind: "rarityCount", rarity: "SR" },
    { id: "ssr5", label: "SSRを5匹釣る", target: 5, reward: 4800, kind: "rarityCount", rarity: "SSR" },
    { id: "ssr20", label: "SSRを20匹釣る", target: 20, reward: 18000, kind: "rarityCount", rarity: "SSR" },
  ...
  fishTypes: [
    ...
    { name: "ハートフィッシュ", points: 85, shadow: 72, speed: 70, biteWindow: 0.64, color: "#c9f0e8", image: "assets/fish/008.png", rarity: "R", catchWeight: 10, catchDifficulty: 1, description: "愛らしい模様をもつ人気者じゃ。近づき方は素直じゃが、見とれておると機を逃すのう。", recommendedSpot: "estuary", sizeHint: "小と中を集めやすい魚じゃ。大になると急に出会いが減るぞい。" },
    ...
    { name: "イワシ", points: 14, shadow: 34, speed: 92, biteWindow: 0.88, color: "#b8d8e6", image: "assets/fish/015.png", rarity: "C", catchWeight: 30, catchDifficulty: 0, description: "小さな銀色の魚じゃ。数は多いが、サイズを揃えようとすると意外に奥深いぞい。", recommendedSpot: "estuary", sizeHint: "小と中が中心じゃ。特大は河口でもかなり根気がいるのう。" },
    { name: "サバ", points: 26, shadow: 48, speed: 78, biteWindow: 0.78, color: "#5f91b5", image: "assets/fish/016.png", rarity: "C", catchWeight: 24, catchDifficulty: 0, description: "よく走る青い魚じゃ。序盤の稼ぎ役として頼れるが、大物狙いでは油断禁物じゃ。", recommendedSpot: "pier", sizeHint: "中が多く、大もそこそこ混ざる。特大は回数勝負じゃな。" },
    { name: "カレイ", points: 32, shadow: 54, speed: 70, biteWindow: 0.76, color: "#c9a56c", image: "assets/fish/017.png", rarity: "C", catchWeight: 20, catchDifficulty: 0, description: "底のほうにじっと構える魚じゃ。派手ではないが、図鑑埋めでは頼もしい一匹じゃ。", recommendedSpot: "reef", sizeHint: "小から大まで幅広い。岩場で大きめを狙いやすいぞい。" },
    { name: "サンゴウオ", points: 82, shadow: 64, speed: 66, biteWindow: 0.62, color: "#ff8f77", image: "assets/fish/018.png", rarity: "R", catchWeight: 9, catchDifficulty: 1, description: "岩場の色にまぎれる鮮やかな魚じゃ。見つけたら、影の動きをよく読むのじゃ。", recommendedSpot: "reef", sizeHint: "中と大が多い。特大は岩場で粘る価値ありじゃ。" },
    { name: "トビウオ", points: 88, shadow: 62, speed: 86, biteWindow: 0.56, color: "#74c7e8", image: "assets/fish/019.png", rarity: "R", catchWeight: 8, catchDifficulty: 1, description: "勢いよく水面近くを走る魚じゃ。反応は速め、合わせは迷わぬことじゃな。", recommendedSpot: "reef", sizeHint: "小と中が多いが、まれに大きな影で飛び込んでくるぞい。" },
    { name: "ヤドカリウオ", points: 96, shadow: 60, speed: 58, biteWindow: 0.6, color: "#d89052", image: "assets/fish/020.png", rarity: "R", catchWeight: 7, catchDifficulty: 1, description: "魚か貝か少し悩む不思議な相手じゃ。独特の間でつつくので焦りは禁物じゃ。", recommendedSpot: "reef", sizeHint: "小さめが多い。サイズコンプには根気がいる魚じゃ。" },
    { name: "オウムガイ", points: 165, shadow: 84, speed: 50, biteWindow: 0.5, color: "#ead0a2", image: "assets/fish/021.png", rarity: "SR", catchWeight: 4, catchDifficulty: 2, description: "古い海の記憶を背負ったような魚影じゃ。深い海で静かに待つと出会いやすいぞい。", recommendedSpot: "deep", sizeHint: "中と大が中心。特大は深い海でもかなり珍しいのう。" },
    { name: "シーラカンス", points: 210, shadow: 102, speed: 44, biteWindow: 0.44, color: "#4e6d7a", image: "assets/fish/022.png", rarity: "SR", catchWeight: 3, catchDifficulty: 3, description: "生きた化石と呼びたい重みのある魚じゃ。影が大きくても、合わせは繊細にいくのじゃ。", recommendedSpot: "abyss", sizeHint: "大と特大の夢が大きい魚じゃ。幻の海溝で狙うのが近道じゃな。" },
    { name: "リュウグウノツカイ", points: 320, shadow: 114, speed: 40, biteWindow: 0.38, color: "#dfe8ff", rarity: "SSR", catchWeight: 1.3, catchDifficulty: 4, description: "長い影がすっと横切る、海の奥からの使者じゃ。終盤装備でも油断ならぬぞい。", recommendedSpot: "abyss", sizeHint: "大以上で現れることが多い。特大はまさしく大記録じゃ。" },
    { name: "ホシクジラ", points: 420, shadow: 128, speed: 34, biteWindow: 0.34, color: "#3f4ea8", rarity: "SSR", catchWeight: 0.9, catchDifficulty: 4, description: "夜空を背負って泳ぐような巨大な魚影じゃ。出会いそのものが冒険の証じゃな。", recommendedSpot: "abyss", sizeHint: "大と特大が本命じゃ。小さめでも価値は十分すぎるほどあるぞい。" },
    { name: "アビスドラゴン", points: 520, shadow: 136, speed: 32, biteWindow: 0.32, color: "#7d4df2", rarity: "SSR", catchWeight: 0.65, catchDifficulty: 4, description: "深淵の名を持つ、最難関級の魚じゃ。浮きが沈んだ瞬間、迷いは置いていくのじゃ。", recommendedSpot: "abyss", sizeHint: "特大は伝説級じゃ。装備とフィーバーを重ねて挑むのがよい。" },
    { name: "トキノサカナ", points: 800, shadow: 92, speed: 72, biteWindow: 0.28, color: "#fff08a", rarity: "SSR", catchWeight: 0.28, catchDifficulty: 4, description: "一瞬だけ時間が止まったように見える幻魚じゃ。博士もまだ一度しか見ておらん。", recommendedSpot: "abyss", sizeHint: "サイズ以前に出会うことが難しい魚じゃ。全サイズ制覇は長い旅になるぞい。" },
  ],
});
