window.GAME_CONFIG = Object.freeze({
  ...
  fishTypes: [
    ...
    { name: "イワシ", points: 14, shadow: 34, speed: 92, biteWindow: 0.88, color: "#b8d8e6", rarity: "C", catchWeight: 30, catchDifficulty: 0, description: "小さな銀色の魚じゃ。数は多いが、サイズを揃えようとすると意外に奥深いぞい。", recommendedSpot: "pier", sizeHint: "小と中が中心じゃ。特大は桟橋でもかなり根気がいるのう。" },
    { name: "サバ", points: 26, shadow: 48, speed: 78, biteWindow: 0.78, color: "#5f91b5", rarity: "C", catchWeight: 24, catchDifficulty: 0, description: "よく走る青い魚じゃ。序盤の稼ぎ役として頼れるが、大物狙いでは油断禁物じゃ。", recommendedSpot: "pier", sizeHint: "中が多く、大もそこそこ混ざる。特大は回数勝負じゃな。" },
    { name: "カレイ", points: 32, shadow: 54, speed: 70, biteWindow: 0.76, color: "#c9a56c", rarity: "C", catchWeight: 20, catchDifficulty: 0, description: "底のほうにじっと構える魚じゃ。派手ではないが、図鑑埋めでは頼もしい一匹じゃ。", recommendedSpot: "reef", sizeHint: "小から大まで幅広い。岩場で大きめを狙いやすいぞい。" },
    { name: "サンゴウオ", points: 82, shadow: 64, speed: 66, biteWindow: 0.62, color: "#ff8f77", rarity: "R", catchWeight: 9, catchDifficulty: 1, description: "岩場の色にまぎれる鮮やかな魚じゃ。見つけたら、影の動きをよく読むのじゃ。", recommendedSpot: "reef", sizeHint: "中と大が多い。特大は岩場で粘る価値ありじゃ。" },
    { name: "トビウオ", points: 88, shadow: 62, speed: 86, biteWindow: 0.56, color: "#74c7e8", rarity: "R", catchWeight: 8, catchDifficulty: 1, description: "勢いよく水面近くを走る魚じゃ。反応は速め、合わせは迷わぬことじゃな。", recommendedSpot: "reef", sizeHint: "小と中が多いが、まれに大きな影で飛び込んでくるぞい。" },
    { name: "ヤドカリウオ", points: 96, shadow: 60, speed: 58, biteWindow: 0.6, color: "#d89052", rarity: "R", catchWeight: 7, catchDifficulty: 1, description: "魚か貝か少し悩む不思議な相手じゃ。独特の間でつつくので焦りは禁物じゃ。", recommendedSpot: "reef", sizeHint: "小さめが多い。サイズコンプには根気がいる魚じゃ。" },
    { name: "オウムガイ", points: 165, shadow: 84, speed: 50, biteWindow: 0.5, color: "#ead0a2", rarity: "SR", catchWeight: 4, catchDifficulty: 2, description: "古い海の記憶を背負ったような魚影じゃ。深い海で静かに待つと出会いやすいぞい。", recommendedSpot: "deep", sizeHint: "中と大が中心。特大は深い海でもかなり珍しいのう。" },
    { name: "シーラカンス", points: 210, shadow: 102, speed: 44, biteWindow: 0.44, color: "#4e6d7a", rarity: "SR", catchWeight: 3, catchDifficulty: 3, description: "生きた化石と呼びたい重みのある魚じゃ。影が大きくても、合わせは繊細にいくのじゃ。", recommendedSpot: "abyss", sizeHint: "大と特大の夢が大きい魚じゃ。幻の海溝で狙うのが近道じゃな。" },
