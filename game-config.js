window.GAME_CONFIG = Object.freeze({
  ...
  fishTypes: [
    { name: "ワカサギ", points: 10, shadow: 30, speed: 96, biteWindow: 0.92, color: "#dce8ec", image: "assets/fish/001.png", rarity: "C", catchWeight: 32, catchDifficulty: 0 },
    { name: "アジ", points: 20, shadow: 42, speed: 82, biteWindow: 0.82, color: "#87b8d6", image: "assets/fish/002.png", rarity: "C", catchWeight: 28, catchDifficulty: 0 },
    { name: "タイ", points: 45, shadow: 58, speed: 68, biteWindow: 0.72, color: "#f17a73", image: "assets/fish/003.png", rarity: "R", catchWeight: 18, catchDifficulty: 1 },
    { name: "スズキ", points: 70, shadow: 76, speed: 58, biteWindow: 0.62, color: "#9fc5ba", image: "assets/fish/011.png", rarity: "R", catchWeight: 14, catchDifficulty: 1 },
    { name: "マグロ", points: 110, shadow: 98, speed: 48, biteWindow: 0.54, color: "#4c73b8", image: "assets/fish/012.png", rarity: "SR", catchWeight: 7, catchDifficulty: 2 },
    { name: "カワハギ", points: 65, shadow: 70, speed: 60, biteWindow: 0.66, color: "#167988", image: "assets/fish/004.png", rarity: "R", catchWeight: 13, catchDifficulty: 1 },
    { name: "マンボウ", points: 90, shadow: 88, speed: 42, biteWindow: 0.58, color: "#f7cbd8", image: "assets/fish/005.png", rarity: "SR", catchWeight: 6, catchDifficulty: 2 },
    { name: "ニジイロギョ", points: 150, shadow: 92, speed: 62, biteWindow: 0.5, color: "#ff5eb8", image: "assets/fish/006.png", rarity: "SR", catchWeight: 4, catchDifficulty: 3 },
    { name: "ヌシ", points: 180, shadow: 104, speed: 38, biteWindow: 0.46, color: "#347d9f", image: "assets/fish/007.png", rarity: "SR", catchWeight: 3, catchDifficulty: 3 },
    { name: "ハートフィッシュ", points: 85, shadow: 72, speed: 70, biteWindow: 0.64, color: "#c9f0e8", image: "assets/fish/008.png", rarity: "R", catchWeight: 10, catchDifficulty: 1 },
    { name: "ムーンフィッシュ", points: 140, shadow: 90, speed: 56, biteWindow: 0.52, color: "#6d67b8", image: "assets/fish/009.png", rarity: "SR", catchWeight: 5, catchDifficulty: 2 },
    { name: "コダマウオ", points: 165, shadow: 86, speed: 66, biteWindow: 0.48, color: "#d9d7f8", image: "assets/fish/010.png", rarity: "SR", catchWeight: 4, catchDifficulty: 3 },
    { name: "タコ", points: 75, shadow: 68, speed: 64, biteWindow: 0.68, color: "#f3a5be", image: "assets/fish/013.png", rarity: "R", catchWeight: 11, catchDifficulty: 1 },
    { name: "ネコギョ", points: 155, shadow: 94, speed: 54, biteWindow: 0.5, color: "#f3c28d", image: "assets/fish/014.png", rarity: "SR", catchWeight: 4, catchDifficulty: 3 },
  ],
});
